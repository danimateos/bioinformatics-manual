...
Find the two proteins with the  smallest pairwise distance. Cluster them. 
...
Numbers in branches are clade credibility values
...
On the right you can find a tree from “A Molecular Phylogeny of Living Primates” (Perelman et al. 2011). Full size link. Answer the following questions based on it:
